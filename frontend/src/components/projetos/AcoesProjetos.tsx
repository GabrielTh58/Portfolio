            ...
            {projeto.link && (
                <>
                    ...
                    <button
                        ...
                        text-white text-sm font-semibold transition-all duration-300 shadow-md hover:shadow-cyan-500/30 disabled:opacity-70"
                    ...
                    <button
                        ...
                        className="flex items-center justify-center px-6 py-3 rounded-lg w-full sm:w-auto border border-zinc-700 bg-zinc-900/50 text-zinc-300 text-sm font-medium hover:border-zinc-500 hover:bg-zinc-800 hover:text-white transition-all duration-300 disabled:opacity-70"
                        disabled={loading !== null}
                    >
                        {loading === "details" ? (
                            <Loader2 size={18} className="animate-spin" />
